  ...
  return (
    <>
      <section className="mb-10 space-y-10 font-mono text-sm">
        <div className="space-x-3 justify-between flex items-start  text-muted">
          <h1 className="space-y-1 flex flex-col">
            <span className="text-heading">abdulsamad ayoade</span>
